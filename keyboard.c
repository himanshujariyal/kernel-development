...
{   
   ...
   else if(((line[0]=='m' || line[0]=='d' || line[0]=='r') && (line[1]=='f' || line[1]=='d')) || (line[0]=='c' && line[1]=='d') || (line[0]=='m' && line[1]=='v') || (line[0]=='c' && line[1]=='p'))
   {
     int i=3,j=0,k=0;
     ...
     else if(c0=='m' && c1=='v') move_file(line,i-3,second,j-k);
     else if(c0=='c' && c1=='p') copy_file(line,i-3,second,j-k);
   }
